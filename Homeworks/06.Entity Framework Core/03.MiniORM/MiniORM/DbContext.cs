    ...
    public abstract class DbContext
    {
        ...
        private bool IsObjectValid(object e)
        {
            ...
            var validationResult = Validator
                .TryValidateObject(e, validationContext, validationErrors, validateAllProperties: true);
        ...
        where TEntity : class, new()
        {
            ...
            foreach (var collection in collections)
            {
                ...
                var mapCollecitonMethod = typeof(DbContext)
            ...
            where TEntity : class, new()
        {
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                var navigaitonPrimaryKey = navigationProperty.PropertyType.GetProperties().First(p => p.HasAttribute<KeyAttribute>());
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPropertyValue = ((IEnumerable<object>)navigationDbSet)
                        .First(currentNavigationProperty => navigaitonPrimaryKey.GetValue(currentNavigationProperty).Equals(foreignKeyValue));
